...
const Questions = () => {
    ...
    const getQuestions = () => {
        axios
            .get(`http://ec2-3-139-54-202.us-east-2.compute.amazonaws.com:8080/questions`, {
                headers: {
    ...
    const getCategories = () => {
        axios
            .get(`http://ec2-3-139-54-202.us-east-2.compute.amazonaws.com:8080/categories`, {
                headers: {
                    'Authorization': cookies.get('token')
                }
            })
    ...
    const getLevels = () => {
        axios
            .get(`http://ec2-3-139-54-202.us-east-2.compute.amazonaws.com:8080/levels`, {
                headers: {
                    'Authorization': cookies.get('token')
                }
            })
    ...
    const createQuestion = () => {
        return fetch("http://ec2-3-139-54-202.us-east-2.compute.amazonaws.com:8080/questions", {
            method: "POST",
            headers: {
